...
steps_array = project[:steps] #Verify I can isolulate the steps array

steps_array.each do |add_step|
  add_step[:committee] = project[:committee].sample
end

puts steps_array #Test output from steps array
puts
